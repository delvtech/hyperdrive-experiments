...
exp_config = sweeps.experiments.Config()  # set custom configs here

# %%
## Log into wandb
wandb.login()
run = wandb.init(config=None, notes=experiment_notes, tags=experiment_tags, mode=mode)
