...
for idx,time_stretch in enumerate(unique_time_stretches):
    ...
    ax.set_title(f"Time Stretch {time_stretch:.0%}, Liquidity {all_results.loc[(all_results.type == 'first') & (all_results.time_stretch_apr == time_stretch),'share_reserves'].iloc[0]:,.0f}")
